...
const ContactSection = () => {
  return (
    <div className="flex flex-col lg:flex-row p-8 bg-gray-50 gap-8 justify-center items-center">
      ...
      <div className="w-full md:w-1/2   lg:w-1/3 p-6 bg-gradient-to-r from-orange-400 to-orange-500 text-white rounded-2xl shadow-xl hover:shadow-2xl transition-shadow duration-300 transform hover:scale-105 flex flex-col justify-between h-60">
      ...
      <div className="w-full md:w-1/2 lg:w-1/3 p-6 bg-gradient-to-r from-sky-400 to-sky-500 text-white rounded-2xl shadow-xl hover:shadow-2xl transition-shadow duration-300 transform hover:scale-105 flex flex-col justify-between h-60">
