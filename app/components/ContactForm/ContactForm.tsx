...
const ContactForm = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Narrow the type by checking if it's an instance of Error
   ...
   <div className='bg-white py-10'>
     <div className="max-w-2xl mx-auto p-6 bg-white shadow-lg rounded-lg">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <button
          type="submit"
          className="w-full py-3 bg-sky-500 text-white font-semibold rounded-lg hover:bg-sky-600 cursor-pointer focus:outline-none focus:ring-2 focus:ring-sky-500"
        >
          Send Message
        </button>
